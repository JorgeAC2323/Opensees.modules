...
def _plot_defo_mode_3d(modeNo, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
    ...
    nen = np.shape(ops.eleNodes(ele_tags[0]))[0]
    nen = 3 #Modificado el 22.09.2021 por JP
    # plot: truss and beam/frame elements in 3d
    if nen == 3: #Modificado el 22.09.2021 por JP
        ...
        if ndf == 6:
            ...
            for i, ele_tag in enumerate(ele_tags):
                if len(ops.eleNodes(ele_tag))!=2: continue;#Modificado el 22.09.2021 por JP
                nd1, nd2 = ops.eleNodes(ele_tag)
    ...
    # plot: quad in 3d
    #elif nen == 3: #Modificado el 22.09.2021 por JP
        ...
        if ndf == 6:
            ...
            for i, ele_tag in enumerate(ele_tags):
                if len(ops.eleNodes(ele_tag))!=4: continue; #Modificado el 22.09.2021 por JP
                nd1, nd2, nd4, nd3 = ops.eleNodes(ele_tag)
